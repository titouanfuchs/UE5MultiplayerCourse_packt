...
UNREALROOTPATH = /home/tfuchs/Softwares/UE/UnrealEngine
GAMEPROJECTFILE =/home/tfuchs/Projects/UE/MultiplayerCourse/MultiplayerCourse.uproject

TARGETS = \
	MultiplayerCourse-Linux-Debug  \
	MultiplayerCourse-Linux-DebugGame  \
	MultiplayerCourse-Linux-Test  \
	MultiplayerCourse-Linux-Shipping  \
	MultiplayerCourse \
	MultiplayerCourseEditor-Linux-Debug  \
	MultiplayerCourseEditor-Linux-DebugGame  \
	MultiplayerCourseEditor-Linux-Test  \
	MultiplayerCourseEditor-Linux-Shipping  \
	MultiplayerCourseEditor \
...
StandardSet: RequiredTools UnrealFrontend MultiplayerCourseEditor UnrealInsights

DebugSet: RequiredTools UnrealFrontend-Linux-Debug MultiplayerCourseEditor-Linux-Debug


MultiplayerCourse-Linux-Debug:
	 $(PROJECTBUILD) MultiplayerCourse Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiplayerCourse-Linux-DebugGame:
	 $(PROJECTBUILD) MultiplayerCourse Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiplayerCourse-Linux-Test:
	 $(PROJECTBUILD) MultiplayerCourse Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiplayerCourse-Linux-Shipping:
	 $(PROJECTBUILD) MultiplayerCourse Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiplayerCourse:
	 $(PROJECTBUILD) MultiplayerCourse Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiplayerCourseEditor-Linux-Debug:
	 $(PROJECTBUILD) MultiplayerCourseEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiplayerCourseEditor-Linux-DebugGame:
	 $(PROJECTBUILD) MultiplayerCourseEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiplayerCourseEditor-Linux-Test:
	 $(PROJECTBUILD) MultiplayerCourseEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiplayerCourseEditor-Linux-Shipping:
	 $(PROJECTBUILD) MultiplayerCourseEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

MultiplayerCourseEditor:
	 $(PROJECTBUILD) MultiplayerCourseEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
